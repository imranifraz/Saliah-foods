...
export function IconPackage() {
  return (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m8.25 3v6.75m0 0l-3-3m3 3l3-3M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-4.875c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v4.875c0 .621.504 1.125 1.125 1.125z" />
    </svg>
  );
}
...
export function IconReview() {
  return (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3h6m-8.25 8.25h10.19c.53 0 1.039-.21 1.414-.586l3.147-3.146A2 2 0 0021 14.354V5.25A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25v12A2.25 2.25 0 005.25 19.5z" />
    </svg>
  );
}
  ...
  return (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36a11.239 11.239 0 01-.665-6.479L3 6.75A2.25 2.25 0 015.25 4.5h13.5A2.25 2.25 0 0119.5 6.75l1.305 7.771c.066.392-.26.754-.668.754H13.5m-9 0V9.75a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 9.75V21m-9-13.5h.008v.008H12V7.5z"
      />
    </svg>
  );
}
