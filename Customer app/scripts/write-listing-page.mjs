...
export function ProductListingPage() {
  ...
  if (!category) {
    return (
      <div className="mx-auto max-w-[1440px] px-4 py-28 sm:px-5 md:px-10">
...
`.replace("<motion.div className=\"bg-cream-50", "<div className=\"bg-cream-50");

writeFileSync("src/pages/ProductListingPage.jsx", content);
console.log("written");
